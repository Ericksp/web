...
$sql = "SELECT * from documentos order by nomdoc asc ";
        ...
        <div class="text">
            <section class="form-register" id="servicioForm">
                ...
                <p>Llene el formulario para poder adquirir el servicio:</p>
                    ...
                    <input class="txtbox" type="text" id="nombre" name="nombre" required placeholder="Escriba su(s) nombres(s)" ><br>
                    
                    <label for="nombre">Apellidos</label><br>
                    <input class="txtbox" type="text" id="apellidos" name="apellidos" required placeholder="Escriba su(s) apellido(s)"><br>

                    <label for="email">Correo electrónico:</label><br>
                    <input class="txtbox" type="email" id="email" name="email"  required placeholder="Escriba su correo electrónico"><br>

                    <label for="email"> Número de Celular:</label><br>
                    <input class="txtbox" type="text" id="cel" name="cel" required placeholder="Escriba su número celular"><br>
            ...
            <section class="form-register" id="segundoPaso" style="display: none;">
                    ...
                    <h2>Registre sus datos : </h2>
                <p>Llene el formulario para poder adquirir el servicio:</p>
                <label for="nombre2">¿ Que Tipo de documento desea ? :</label><br>
                    <label  for="opciones">Selecciona una opción:</label>
                    <select class="txtbox" id="opciones" name="opciones">
                    <option value="">Seleccione</option>
                    <?php
                            while ($row = $result->fetch_assoc()) { ?>
                        <option value="<?php echo $row['coddoc']; ?>" data-precio="<?php echo $row['predoc']; ?>"><?php echo $row['nomdoc'] .' -  S./'.  $row['predoc'] ; ?></option>
