...
<body>
    ...
    <div class="general">
        ...
        <h2>Misas</h2>
                <ul>
                <li class="fa fa-check-double"></li><a> Misas Personales(Salud-Difuntos-Aniversario-Renovación Matrimoniales)</a> <br>
                <li class="fa fa-check-double"></li><a> Misas Comunitarias</a><br>
                <li class="fa fa-check-double"></li><a> Misas Festivas</a><br>
                <li class="fa fa-check-double"></li><a> Velatorios</a>
                </ul>
                <div class="header-content container">
                    <a href="reservar.php" class="btn-1">Reservar Servicio</a>
                    <br>
                    <br>
                </div>
        </div>
